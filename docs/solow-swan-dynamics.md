...
This extends the [original square-root case study](solow-swan.md) to **every
...
The earlier [square-root example](../examples/SolowSwan.lean) detects loss of
...
The new [dynamics example](../examples/SolowSwanDynamics.lean) adds:
...
The [complete contribution package](../contributions/lean-economics-solow-dynamics/README.md)
