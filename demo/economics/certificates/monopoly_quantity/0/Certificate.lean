...
def original : Prop :=
  ∀ (v0 : ℝ), ∀ (v1 : ℝ), ∀ (v2 : ℝ), ∀ (v3 : ℝ), (v0 > (0 : ℝ)) → (v1 > (0 : ℝ)) → ((((2 : ℝ) * v0) * v2) = (- v1)) → (v3 = (- (v0 * v2))) → (v2 < (0 : ℝ))
...
theorem satisfying : ∃ (_v0 : ℝ), ∃ (_v1 : ℝ), ∃ (_v2 : ℝ), ∃ (_v3 : ℝ), (((_v0 > (0 : ℝ)) ∧ (_v1 > (0 : ℝ)) ∧ ((((2 : ℝ) * _v0) * _v2) = (- _v1)) ∧ (_v3 = (- (_v0 * _v2)))) ∧ (_v2 < (0 : ℝ))) := by
  refine ⟨(1 : ℝ), (2 : ℝ), (-1 : ℝ), (1 : ℝ), ?_⟩
  norm_num
