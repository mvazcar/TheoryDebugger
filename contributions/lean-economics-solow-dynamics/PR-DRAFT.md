...
derives strict positivity for nonnegative solutions using weighted capital,
establishes uniqueness by an integrating factor, and
...
Validation: full project build; fresh re-elaboration of all 59 contributed
